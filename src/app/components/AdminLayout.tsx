...
export function AdminLayout({ children, pageTitle }: AdminLayoutProps) {
  ...
  return (
    <div className="admin-console min-h-screen flex" style={{ background: "var(--background)" }}>
      {/* Desktop Sidebar */}
      <aside
      ...
      >
        ...
        <div className="px-3 py-4 border-b" style={{ borderColor: "var(--sidebar-border)" }}>
          <Link to="/" className="block">
            ...
            <div className="smart-sidebar-label text-[10px] uppercase tracking-[0.2em] text-muted-foreground mt-2 pl-1">Admin Console</div>
          </Link>
        </div>
        ...
        <div className="px-3 pt-3">
          ...
          >
            ...
            <div className="flex items-center gap-1.5 mt-1.5">
              ...
              <span className="smart-sidebar-label text-xs text-accent-violet font-medium">Full Access</span>
            </div>
          </div>
        </div>
            ...
            return (
              ...
              >
                <span className="smart-sidebar-icon">
                  <item.icon className={`w-5 h-5 shrink-0 ${active ? "text-accent-violet" : ""}`} />
                </span>
                <span className="smart-sidebar-label flex-1">{item.label}</span>
                {active && <div className="smart-sidebar-label w-1.5 h-1.5 rounded-full bg-accent-violet" />}
              </Link>
            );
          })}
          </div>
