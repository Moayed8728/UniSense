...
import { MapPin, Clock, GraduationCap, Star, Eye, DollarSign } from "lucide-react";
import { ImageWithFallback } from "./figma/ImageWithFallback";
import { Program, formatFee, formatDuration } from "../data/programs";
...
export function ProgramCard({ program, matchedTerms }: ProgramCardProps) {
  return (
    <Link
      ...
      className="group glass-card rounded-2xl overflow-hidden shadow-premium glass-card-hover border-glow flex flex-col"
    >
      <div className="relative h-40 overflow-hidden">
        ...
        <span className="absolute top-3 right-3 inline-flex items-center gap-1 px-2.5 py-1.5 rounded-full bg-background/70 backdrop-blur-sm text-xs font-semibold text-warning">
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <p className="text-sm text-muted-foreground mb-3">{program.university}</p>
        ...
        <div className="mt-auto flex items-center justify-between">
          ...
          <span className="text-sm font-semibold text-accent-blue group-hover:gap-2 inline-flex items-center gap-1 transition-all">
            View details
