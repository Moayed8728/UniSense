...
import { programs, formatFee, formatDuration } from "../../data/programs";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            <div className="glass-card rounded-2xl p-6 shadow-premium-lg border-glow">
              ...
              <button className="w-full py-3 rounded-xl gradient-primary text-white font-semibold shadow-premium hover:shadow-premium-lg transition-all mb-3">
                Visit Official Page
              </button>
              <button className="w-full py-3 rounded-xl glass-card text-foreground font-semibold border-glow transition-all">
                Save Program
              </button>
            </div>
