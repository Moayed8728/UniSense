        ...
        <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="group relative glass-card rounded-3xl p-8 shadow-premium-lg glass-card-hover border-glow overflow-hidden">
              ...
              <div className="relative">
                ...
                <button className="px-6 py-3 gradient-primary text-white rounded-xl font-semibold shadow-premium hover:shadow-premium-lg hover:scale-105 transition-all">
                  Start Searching
                </button>
              </div>
            </div>
            ...
            <div className="group relative glass-card rounded-3xl p-8 shadow-premium-lg glass-card-hover border-glow overflow-hidden">
              ...
              <div className="relative">
                ...
                <Link to="/student/ai-recommendations" className="inline-block px-6 py-3 bg-accent-violet text-white rounded-xl font-semibold shadow-premium hover:shadow-premium-lg hover:scale-105 transition-all">
                  Get Recommendations
                </Link>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="glass-card rounded-2xl p-6 shadow-premium border-glow">
              ...
              <button className="text-sm text-accent-blue hover:text-accent-blue/80 font-semibold">
                Start Comparing →
              </button>
            </div>

            <Link to="/student/chat" className="glass-card rounded-2xl p-6 shadow-premium border-glow hover:shadow-premium-lg transition-all block cursor-pointer">
              <div className="relative mb-4 w-fit">
              ...
              <span className="inline-block text-sm text-success hover:text-success/80 font-semibold">
                Open Chat →
              </span>
            </Link>
